  			...
  			<div class="container-fluid">
    			<div class="navbar-header">
			      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
      			  ...
      			  <a class="navbar-brand" href="resource_management/user.jsp#/home">RESOURCE MANAGEMENT</a>
   			   </div>
			    <div class="collapse navbar-collapse" id="myNavbar">
				      <ul class="nav navbar-nav">
				        <li class="active"><a href="resource_management/user.jsp#/home">Home</a></li>
				        <li><a href="resource_management/user.jsp#/project">Projects</a></li>
				        <li><a ng-href="resource_management/user.jsp#/teams">Teams</a></li>
				      </ul>
