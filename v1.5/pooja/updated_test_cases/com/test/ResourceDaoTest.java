...
public class ResourceDaoTest {
	...
	public void TestCreateResource() throws Exception{
		...
		Resource resource=new Resource("poojaswadekar","active", roleList,projectList, teamDao.getTeamById(team));
...
resource.setResourceId(5);
		...
		resource1.setResourceName("aakash");
		resource1.setResourceStatus("active");
		resource1.setTeam(team1);
		
		
	
	
	resourceDao.updateResource(resource1);		
