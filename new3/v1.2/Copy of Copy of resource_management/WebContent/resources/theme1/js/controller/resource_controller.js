...
App.controller('ResourceController', ['$scope', 'ResourceService', function($scope, ResourceService) {
    ...
    self.resources=[{resourceId:1,resourceName:'aakash',resourceStatus:'active',roles:[{roleName:'asd',roleType:'dwe'},{roleName:'agfbfgd',roleType:'ddswe'}]},{resourceId:3,resourceName:'aak',resourceStatus:'active',roles:[{roleName:'asdtegtr',roleType:'dwereg'},{roleName:'agfbfgd',roleType:'ddswe'}]},{resourceId:2,resourceName:'ashwin',resourceStatus:'deactive'}];
    self.search={field:''}
